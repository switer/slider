(function (global) {
	...
	global.colorboard.create =  function (cmdCall) {
	        ...
	        $(colorSelector).attr('style',"display: none;position: absolute;width: 190px;height: 170px;top: 50px;right: 0px;background-color: #FAFAFA;border-radius: 2px;border: 1px solid #CCC;z-index: 999;");
